<template>
  <router-view v-slot="{ Component, route }">
    <a-layout class="h-100vh" v-if="!route.meta.hideLayout">
      ...
      <a-layout class="p-0">
        <div class="py-25px px-15px h-24px flex justify-between items-center bg-[var(--layout-bg-color)]">
        ...
        <a-layout-content
          class="p-10px min-h-280px min-w-280px bg-[var(--bg-color)] h-[calc(100vh-64px)] overflow-y-auto">
          <!-- 路由视图 -->
